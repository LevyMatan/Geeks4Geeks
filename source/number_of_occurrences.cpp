 ...
 * @brief Given a sorted array Arr of size N and a number X, you need to find the number of
 ...
 * which takes the array of integers arr, n, and x as parameters and returns an integer denoting the
 * answer. If x is not present in the array (arr) then return 0.
 *
